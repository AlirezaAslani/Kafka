...
public class OpenSearchConsumer_BulkRequest {
    ...
    public static void main(String[] args) {
        Logger log = LoggerFactory.getLogger(OpenSearchConsumer_BulkRequest.class.getSimpleName());
            ...
            while (true){
                ...
                for(ConsumerRecord<String,String> record: records){
                    ...
                    try {
                        ...
                        /** So instead of doing this one to insert the index, into OpenSearch every time we have one record
                         we are going to BulkRequest */
